...
public class SemwebRates {
  public static final double MIN_DBPEDIA_RATE = 0.4;
  public static final double MIN_SPOTLIGHT_RATE = 0.2;
  public static final double INITIAL_RATE = 0.8;
  public static final double DIFF_RATE = 0.2;
  public static final int NUMBER_OF_CONNECTIONS_DIVIDER = 4;
}
