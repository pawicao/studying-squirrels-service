...
public interface PersonRepository extends Neo4jRepository<Person, Long> {
  ...
  List<Person> findTutors(
      Long id, String cityName, Double rating, List<String> subjects, Double maxPrice);
  ...
  List<Person> findNearTutorsWithPostalCode(
      Long id, Double rating, List<String> subjects, Double maxPrice);
  ...
  List<Person> findRecommendedTutorsWithPostalCode(
      Long id, Double rating, List<String> subjects, Double maxPrice);
  ...
  @Query(
      "MATCH (tutor:Person)-[gave:GAVE]->(l:Lesson)<-[t:TOOK]-(:Person)-[:IS_FRIEND {accepted: true}]-(student:Person) "
          ...
          + "RETURN tutor as person, tutorPlace as placeOfResidence, city, offer as offeredSubject, sub as subject "
          + "ORDER BY averageTutorRating DESC")
  List<Person> findRecommendedTutors(
      Long id, Double rating, List<String> subjects, Double maxPrice);
